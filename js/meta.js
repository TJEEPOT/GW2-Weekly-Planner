...
export const META = {
  ...
  269: {
    ...
    stage_count:    1,
    time_verified:  true,
    tip:            "Complete a tier 1 fractal via Quickplay, the Fractals portal is in Lion's Arch near Fort Marriner. If you want to do a convergence instead, public groups run every 90 minutes, alternating between Mount Balrior and Outer Nayos.",
    waypoint:       "[&BDAEAAA=]",
    timed:          false,
