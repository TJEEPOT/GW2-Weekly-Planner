...
export const META = {
  ...
  149: {
    ...
    stage_count:    25,
    time_verified:  true,
    tip:            "Completes naturally alongside almost any other PvE objective. For a dedicated run: Pocket Raptors south of Westwatch WP (Auric Basin) spawn in large packs, or Fireflies and Scaled Drakes south-west of Wardenhurst WP (Caledon Forest) are low-level and fast to clear.",
    waypoint:       "[&BAYIAAA=]",
    timed:          false,
    priority:       PRIORITY.LOW,
  },
